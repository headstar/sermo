...
public class USSDStates {
    ...
    public static <S, E extends DialogEvent> USSDState<S, E> menuInputState(S id, Action<S, E> entryAction) {
        DefaultUSSDState.Builder builder = DefaultUSSDState.builder(id);
    ...
    public static <S, E extends DialogEvent> USSDState<S, E> pagedMenuInputState(S id, Action<S, E> entryAction) {
